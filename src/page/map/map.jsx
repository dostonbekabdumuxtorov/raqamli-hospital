            ...
            <div className="map-wrap">
                <div className="map-wrap__left">
                    <div className="map-wrap__left-top">
                        <input  onChange={(e)=>on_search(e.target.value)}  className="map-wrap__left-input" type="text" />
                        <button className="map-wrap__left-btn">Qidiruv</button>
                    </div>

                    {
                        Cards.length === 0 ? <h1>Topilmadi...</h1> :
                            Cards.map((item) => (
                                    ...
                                    <div className="card-container">
                                        ...
                                        <div className="clinics__bottom1">
                                            ...
                                            >
                                                ...
                                                >
                                                    <Typography style={{fontFamily:"Poppins"}}>Bo'limlar</Typography>
                                                </AccordionSummary>
                                                <AccordionDetails>
                                                    <Typography>
